...
s.source       = { :http => 'https://raw.githubusercontent.com/oneframemobile/location-manager-ios/master/LocationManager.zip'}
...
s.ios.vendored_frameworks  = 'LocationManager.framework'
